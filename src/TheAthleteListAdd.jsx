                        ...
                        {editingId === a.id ? (
                          ...
                          <>
                           ...
                           <button
                             className="secondary-btn"
                             onClick={() => deleteAthlete(a)}
                             disabled={a.registration_date !== new Date().toISOString().split("T")[0]}
                             title={a.registration_date !== new Date().toISOString().split("T")[0] ? "Delete allowed only on the day of registration" : "Delete"}
                           >
                             Delete
                           </button>
                           <button
